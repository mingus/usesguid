== Changes in ZangZing's Fork

* Updated uuidtools library to https://github.com/sporkmonger/uuidtools/commit/45b0970a8cdaefb923e5d261307b995a9ee46396

* Added option to use ActiveRecord::Base.guid_generator = :random to generate SecureRandom seeded UUIDs
